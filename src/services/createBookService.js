...
const getBookData = async (req, res) => {
  try {
    await bookController.getBookData()
    .then((books) =>{
...
const createBook = async (req, res) => {
  try {
    ...
    await bookController.addBook(ISBN, name, author, genre, copies, publication, fine)
...
const updateBook = async (req, res) => {
  try {
    ...
    await bookController.updateBook(id, name, author, genre, copies, date, fine)
